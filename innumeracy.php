...
$featurearray = array("Gender" => array("Male","Female"),"Political party" => array("Liberal Democratic Party","Constitutional Democratic Party","New Komeito","Japan Restoration Association","Communist Party","National Democratic Party","Social Democratic Party","Reikawa Shinsengumi","The party to protect people from old political parties"),"Political experience" => array("15 years","5 years","0 years"),"Age" => array("Liberal","66-75","45-55","56-65"),"Marital status" => array("Currently married","Single (never married)","Single (divorced)"),"Children" => array("None","1","2","More than 2"),"Education" => array("4 year undergraduate degree","Masters degree","PhD degree"));

$restrictionarray = array(array(array("Partisanship","Republican"),array("Ideology","Liberal")));
